...
export function isInStandaloneMode() {
    return Boolean(('standalone' in window.navigator) && ((window.navigator as any).standalone));
}
...
export async function fetchSource(fs: any, { content, path, url }: Source): Promise<Uint8Array> {
